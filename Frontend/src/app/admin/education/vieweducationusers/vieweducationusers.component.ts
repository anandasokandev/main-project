...
@Component({
  selector: 'app-vieweducationusers',
  templateUrl: './vieweducationusers.component.html',
  styleUrls: ['./vieweducationusers.component.scss']
})
export class VieweducationusersComponent {
userProfile: any[] = [];
    ...
    applyFilters(): void {
      ...
      this.db.fetchAdmissionUsers(this.filteredProfiles).then((data: any) => {
    ...
    viewProfile(login_id: any){
      this.router.navigate(['/admin/education/view-careeruser'],{queryParams: {id: login_id }})
    }
