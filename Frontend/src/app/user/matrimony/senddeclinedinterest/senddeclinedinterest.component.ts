...
@Component({
  selector: 'app-senddeclinedinterest',
  templateUrl: './senddeclinedinterest.component.html',
  styleUrls: ['./senddeclinedinterest.component.scss']
})
export class SenddeclinedinterestComponent {
  constructor(private db: DatabaseService, private router: Router) {}
        ...
        ngOnInit(): void {
          this.db.fetchsendinterestdeclined(this.login_id).then((data: any) => {
            console.log(data);
            this.details = data;
          });
        }
